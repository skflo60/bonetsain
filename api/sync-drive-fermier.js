...
const getObjects = async (offset = 0, limit = 50, container_id = '5f8d55ec03815518b10a4700') => {
  ...
  const syncDriveFermier = async () => {
    ...
    const excludeList = ["Panier pot au feu 1 unité(s)", "Panier crudité 1 unité(s)", "Panier potager 1 unité(s)", "Panier printanier 1 unité(s)", "Panier soupe 1 unité(s)", "Betterave cuite 0.5 kg", "BLANQUETTE DE VEAU (FLANCHET) DISPO LE 02...", "Panier de légumes 10€ 1 unité(s)", "Panier de légumes 15€ 1 unité(s)"];
